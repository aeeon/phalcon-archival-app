    ...
    <div class="content">
        {% if registry.cms['TECHNICAL_WORKS'] %}
            <div class="ui red inverted segment">
               Strona jest w trakcie modernizacji.<br>
            Prosimy nie realizować żadnych działań dopóki prace nie zostaną ukończone.
        ...
        <hr>
        <a href="http://www.creativewds.com" class="works-on" target="_blank">Powered by CreativeWDS</a>
