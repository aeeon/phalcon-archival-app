...
class Storage extends Component
{
     ...
     * <img src="" alt="" />
     */
    public function imageHtml($class="")
    {
        ...
        $result = '<img '. $attr_class . $attr_src . $this->attributesResultForImageHtml($attributes) . '/>';
    ...
    private function checkOriginalExists($originalAbsPath)
    {
        if (!file_exists($originalAbsPath)) {
            ...
            if (IMG_DEBUG_MODE) {
                ...
                throw new \Exception("Plik {$originalAbsPath} nie istnieje");
            } 
            return;
        }
    }
