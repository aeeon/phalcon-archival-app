...
class Publication extends Model {
    ...
    protected $attachmentsModel = 'Publication\Model\PublicationAttachments';
    private $id;
    private $user_id;
    private $type_id;
    // private $category_id;
    ...
    public function initialize() {
        ...
        $this->hasMany('id', $this->attachmentsModel, 'publication_id', [
            'alias' => 'attachments',
            'order' => 'id DESC',
        ]);
    ...
    public function updateFields($data) {
        ...
        $cats = array();
        $items = \Publication\Model\PublicationCategories::find(array("conditions"=>"publication_id='{$this->id}'"));
...
//        $categories = array_keys($data['categories']);
    ...
    //    $cats = \Tree\Model\Category::find("id IN (" . implode(",", $categories) . ")");
        foreach($categories as $cat=>$value) {
          $item= new   \Publication\Model\PublicationCategories();
          $item->setCategory_id($cat);
          $item->setPublication_id($this->id);
          $item->save();
        //  $item = \Tree\Model\Category::findFirst($cat);
          //$item->setId($cat);
        /*  if($item)
              $cats[] = $item;*/
        } 
