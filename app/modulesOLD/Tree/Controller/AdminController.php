...
class AdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $this->helper->title($this->helper->at('Drzewo kategorii'), true);
    }
    ...
    public function editAction($id)
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($form->isValid()) {
                if ($model->save()) {
                    $this->flash->success($this->helper->at('Aktualizacja pomyślna'));
                    $this->redirect($this->url->get() . 'tree/admin?lang=' . LANG);
                } else {
        ...
        $this->helper->title($this->helper->at('Edytuj wpis'), true);
