...
<nav id="header-nav">                       
    <div class="main-menu col-lg-8 col-md-12">
        <ul id="main-menu-ul">
            ...
            <li id="menu-item-{{loop.index}}" class="col-lg-2 col-md-2"><div class="icon-sprite icon-sprites-{{loop.index}}"></div>
...
<nav class="mobile-menu">
    <ul>
        ...
        {% if loop.index == 5 %}
        <li><a id="a-mobile-oferta" href="{{ item['entry'].custom }}">{{ item['entry'].title|striptags }}</a></li> 
    ...
    <div class="col-lg-6 col-md-6 border-r">
        ...
        <div class="col-lg-6 col-md-6 border-r">
            <a class="title-link" href="/oferta.html">
                ...
                <img src="/assets/img/icons-sprites.png" class="icon-sprites-8" width="40" height="40" alt="">
                <h4>DLA FIRM</h4>
        ...
        <div class="col-lg-6 col-md-6">
            ...
            <a class="title-link" href="/oferta2.html">
                ...
                <img src="/assets/img/icons-sprites.png" class="icon-sprites-9" width="40" height="40" alt="">
